...
export const leadConversionData = {
  ...
  security: { field: "security", estimated_conversions: 28, conversion_rate_trend: [0.25,0.27,0.26,0.29,0.28,0.30,0.31,0.33], consultation_count_trend: [80,85,78,90,88,95,92,100], recommendations: ["보안 자격증 시즌에 맞춘 프로모션을 준비하세요.","기업 교육 연계 프로그램을 홍보하세요.","취업 연계 성공 사례를 마케팅에 활용하세요."] },
  game: { field: "game", estimated_conversions: 35, conversion_rate_trend: [0.28,0.30,0.29,0.32,0.31,0.34,0.33,0.36], consultation_count_trend: [95,100,92,105,98,110,108,115], recommendations: ["게임 포트폴리오 완성 과정을 강조하세요.","방학 시즌 집중 과정을 준비하세요.","게임잼 이벤트와 연계한 홍보를 추진하세요."] },
  art: { field: "art", estimated_conversions: 22, conversion_rate_trend: [0.20,0.22,0.21,0.24,0.23,0.25,0.26,0.28], consultation_count_trend: [65,70,68,75,72,78,80,82], recommendations: ["포트폴리오 리뷰 세션을 무료로 제공하세요.","SNS 채널을 통한 작품 공유 이벤트를 진행하세요.","취미반과 전문반을 분리하여 타겟팅하세요."] },
};
