...
> **작성일:** 2026-04-08
> **최종 수정:** 2026-04-10 (FEATURE_COLUMNS 19개 반영)
...
### 14.3 FEATURE_COLUMNS 매핑 (19개)

최종 `training_dataset.csv`의 컬럼 중, 모델이 학습에 사용하는 19개 피처 (`xgboost_model.py:FEATURE_COLUMNS`):
...
| `cart_abandon_rate` | 학원에 장바구니 개념 없음 — **v2에서 완전 삭제** |
...
| ~~`cart_abandon_rate`~~ | 삭제됨 (학원에 장바구니 개념 없음) |
